...
import { CsvViewerComponent } from './components/viewers/csv.viewer.component';
...
@NgModule({
    ...
    providers: [
        ...
        }),
        {
            ...
            multi: true,
            useValue: () => {
                const extensions = inject(AdfExtensionService);
                // Heavy child components are lazy-loaded within the component itself via @defer.
                extensions.setComponents({ 'viewers.csv': CsvViewerComponent });
            },
        },
    ],
})
